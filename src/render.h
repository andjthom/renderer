...
void R_DrawPoint(const R_Framebuffer *framebuffer, const Vec4f color, const Vec2f point);
void R_DrawLine(const R_Framebuffer *framebuffer, const Vec4f color, const Vec2f pts[2]);
void R_DrawTriangle(const R_Framebuffer *framebuffer, const Vec4f color, const Vec2f pts[3]);
void R_RasterizeTriangle(const R_Framebuffer *framebuffer, const Vec4f color, const Vec2f pts[3]);
